...
const MembershipCard: React.FC<MembershipCardProps> = ({ title, price, features, onSelect }) => {
  return (
    <div className="bg-neutral-900 p-12 my-20 rounded-xl shadow-xl w-full max-w-sm text-center flex flex-col justify-between h-full">
      ...
      <button
        className="bg-pink-500 text-white py-2 px-4 rounded-lg hover:bg-pink-600 focus:outline-none mt-auto"
        onClick={onSelect}
      >
        Choose Plan
      </button>
